...
class c_code_2_mermaid:
    ...
    def create_mermaid_block(self, line_code, line_id):
        line_block = f"""
            subgraph {line_id}
                direction TB 
                {line_id}_du["def= <br> use=  "] 
                {line_id}_code["{line_code} "] 
            end \n"""
        self.order_code_mermaid += f'{line_id}_group \n'
        return line_block
    ...
    def write_md_file(self):
        ...
        # self.md_output_string += self.order_code_mermaid
...
if __name__ == "__main__":
    ...
    md_output = r"Output/Mermaid_def-use.md"
